...
namespace Kogane
{
	public static partial class GetComponentWithLogExtensionMethods
	{
		...
		/// </summary>
		public static T GetComponentWithLog<T>( this Component self ) where T : Component
		{
		...
		/// </summary>
		public static T GetComponentInChildrenWithLog<T>( this Component self ) where T : Component
		{
		...
		/// 自分自身もしくは子からコンポーネントを取得します。取得できなかった場合はログを出力します
		/// </summary>
		public static T GetComponentInChildrenWithLog<T>( this Component self, bool includeInactive ) where T : Component
		{
		...
		/// </summary>
		public static T GetComponentInParentWithLog<T>( this Component self ) where T : Component
		{
		...
		/// </summary>
		public static T FindComponentWithLog<T>( this Component self, string name ) where T : Component
		{
